...
const buildQuery = (addresses: string[]) => `
  ...
  SELECT l.address, c."realbetUserId" FROM "LinkedWallet" l JOIN "CasinoLink" c ON l."dynamicUserId" = c."dynamicUserId" JOIN addresses a ON l.address = a.address
`;

export const getDashboardAccounts = async (addresses: string[]) => {
